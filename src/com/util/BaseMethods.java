...
public class BaseMethods {
	...
	public static void sendUpdateMail(String receiver,String data){
	...
	public static void sendConfirmationMail(String receiver,String userName){
	...
	Properties props = new Properties();
		...
		try {
			...
			message.setText("Hey ,  " + userName + " your Loan  is successfully Approved!! "  );
