    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Loan Request Table</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <c:forEach items="${verifyLoanRequest}" var="i" varStatus="j">
							<tr>
								<td>${j.count}</td>
								<td>${i.loginVO.email}</td>
								<td>
									<a target="_blank" href="<%=request.getContextPath()%>/documents/${i.loginVO.id}/${i.photoName}">
										<img alt="" src="<%=request.getContextPath()%>/documents/${i.loginVO.id}/${i.photoName}" style="height: 100px;width: 100px;">
									</a>
								</td>
								<td>
									<a target="_blank" href="<%=request.getContextPath()%>/documents/${i.loginVO.id}/${i.panCardName}">
										PanCard
									</a>
								</td>
								<td>
									<a target="_blank" href="<%=request.getContextPath()%>/documents/${i.loginVO.id}/${i.residentialProofName}">
										Residence Proof
									</a>
								</td>
								<td>
								
									<c:if test="${i.status eq 'UNDER REVIEWED' }">
										
										<button class="btn btn-outline-primary">
	                               			<a href="approvedDocuments.html?id=${i.id}">Approve</a>
	                               		</button>
	                               		
                               			<button class="btn btn-outline-primary">
                               				<a href="rejectDocuments.html?id=${i.id}">Reject</a>
                               			</button>
                               		</c:if>
                               		
                               		<c:if test="${i.status ne 'UNDER REVIEWED' }">
                               			${i.status}
                               		</c:if>
